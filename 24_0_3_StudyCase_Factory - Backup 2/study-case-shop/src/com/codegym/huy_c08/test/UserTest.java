...
import static com.codegym.huy_c08.entity.UserType.*;
public class UserTest {
    public static void main(String[] args) {
        ...
        ArrayList<Admin> adminsRead = (ArrayList<Admin>) fileHandler.readFromFile(Constants.ADMIN_FILE_PATH, adminType);
        ArrayList<NormalUser> userListRead = (ArrayList<NormalUser>) fileHandler.readFromFile(Constants.USER_FILE_PATH, userType);
