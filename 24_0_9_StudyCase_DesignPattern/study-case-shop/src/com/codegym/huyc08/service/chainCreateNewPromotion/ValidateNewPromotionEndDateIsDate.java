...
public class ValidateNewPromotionEndDateIsDate implements HandlerNewPromotion {
    private final Scanner SCANNER;
    private HandlerNewPromotion next;

    public ValidateNewPromotionEndDateIsDate(HandlerNewPromotion next) {
    ...
    public boolean doHandle(RequestNewPromotion requestNewPromotion) {
        Validator validateDate = new ValidatorRegexDate(requestNewPromotion.getPromotionDateEnd());
