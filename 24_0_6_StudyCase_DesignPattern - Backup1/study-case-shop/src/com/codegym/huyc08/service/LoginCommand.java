...
public class LoginCommand implements Command {
    ...
    private NavigationUserProfile navigationUserProfile;
    ...
    public void execute() {
        ...
        if(validator.isLikeable(this.inputUsername, Constants.ADMIN_REGEX)) {
            ...
            if(validator.isUserExist(this.inputUsername, this.inputPassword)) {
                System.out.println("Login successful");
                navigationUserProfile =  new NavigationUserProfile(getCurrentUser(), this.normalUsers);
                navigationUserProfile.navigationUserProfile();
            } else {
