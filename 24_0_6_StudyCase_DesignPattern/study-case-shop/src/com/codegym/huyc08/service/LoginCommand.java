...
import com.codegym.huyc08.menu.NavigationAdmin;
    ...
    public void execute() {
        ...
        if(validator.isLikeable(this.inputUsername, Constants.ADMIN_REGEX)) {
            if (validator.isAdminExist(this.inputUsername, this.inputPassword)) {
                ...
                navigationAdmin = new NavigationAdmin(getCurrentAdmin(), this.admins, this.normalUsers);
                navigationAdmin.navigationAdminMenu();
            }
        } else {
